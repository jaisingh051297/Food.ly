        ...
        <div className='w-full flex flex-col items-center justify-center'>
            ...
            { categories && categories.map(category =>(
                ...
                className={ `group ${filter === category.urlParamName 
                    ...
                    gap-3 items-center justify-center hover:bg-orange-600`}
                ...
                >
                    ...
                    <p className={`text-sm ${filter === category.urlParamName ?
                         'text-white': 'text-textColor'} group-hover:text-white`}>
                    {category.name}
                    </p>
                </motion.div>
                ))
            ...
            <div className='w-full'>
                <RowContainter flag={false} data={foodItems?.filter(n => n.category === filter)} />
            </div>
        </div>
    </section>
  )
